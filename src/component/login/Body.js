function Body({ handleLogin }) {
  return (
    <section className='pt-[40px] px-[30px] pb-[100px] w-full'>
      <div className='grid grid-cols-2 gap-2 pt-[55px] max-w-[1195px] mx-auto'>
        <div className='text-left'>
          <div className='w-[20px] pt-20'></div>
          <div className='text-[90px] tracking-[-4px] leading-[85px] text-transparent bg-clip-text bg-linear pb-4'>
            Tụ họp <br />
            mọi lúc, mọi <br /> nơi
          </div>
          <div className='text-xl mb-10'>
            Với Messenger, việc kết nối với những người
            <br /> mình yêu mến thật đơn giản và thú vị.
          </div>
          <div>
            <a
          ...
          <div className='my-8'>
            <a className='text-[#4d4dff] cursor-pointer underline'>
        ...
        <div>
          <img src={process.env.PUBLIC_URL + '/img/showD.png'} alt='' />
        </div>
      </div>
    </section>
  );
